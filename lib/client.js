 ...
 *
 * - the Ponytail card on the Plugins page, keyed on the
...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CSS = [
      '.dp-page{display:flex;flex-direction:column;gap:10px}',
    ...
    const en = {
      title: 'Ponytail',
      summary: 'Lazy senior dev mode. The level persists in settings.',
    ...
    function createCard(scope, t) {
      ...
      return function PonytailCard(props) {
